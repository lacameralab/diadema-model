...
stim_pattern = 'DoG';
% stim_pattern = 'square';
% stim_pattern = 'Hermitian';
% stim_pattern = '2square';
% stim_pattern = 'Morlet';
...
if strcmp(stim_pattern,'bar')
    stim.width = 40; % deg, width of stimulus
    stim = creatStimulus(stim_pattern,stim.width,stim.center,acc);
elseif strcmp(stim_pattern,'DoG')
    stim.width = 69; % 29; % deg, width of stimulus
    stim = creatStimulus(stim_pattern,stim.width,stim.center,acc);
elseif strcmp(stim_pattern,'square')
    stim.width = 69; % deg, width of stimulus
    stim = creatStimulus(stim_pattern,stim.width,stim.center,acc);
elseif strcmp(stim_pattern,'Hermitian')
    stim.width = 69; % deg, width of stimulus
    stim = creatStimulus(stim_pattern,stim.width,stim.center,acc);
elseif strcmp(stim_pattern,'2square')
    stim.width = 69; % deg, width of stimulus
    stim = creatStimulus(stim_pattern,stim.width,stim.center,acc);
elseif strcmp(stim_pattern,'control')
